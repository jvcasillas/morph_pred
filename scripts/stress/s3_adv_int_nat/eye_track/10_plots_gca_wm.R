...
stress_p1 <- model_preds_wm$fits_all_wm %>%
  ...
  ggplot(., aes(x = time_zero, y = fit, ymax = ymax, ymin = ymin,
                fill = coda, color = coda, lty = `Working memory`)) +
...
ggsave(paste0(figs_path, "/stress_p1.png"), stress_p1, width = 150,
       height = 120, units = "mm", dpi = 600)
ggsave(paste0(figs_path, "/stress_p1.eps"), stress_p1, width = 150,
